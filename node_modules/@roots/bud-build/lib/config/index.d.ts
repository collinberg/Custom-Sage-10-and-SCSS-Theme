...
export { bail, cache, context, dependencies, devtool, entry, experiments, externals, externalsType, infrastructureLogging, loader, mode, module, name, node, optimization, output, parallelism, performance, plugins, profile, recordsPath, resolve, stats, target, };
