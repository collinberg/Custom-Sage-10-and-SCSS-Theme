...
export default interface Hooks extends BaseService {
     ...
     * @public
     */
    fire: <T extends `${keyof Registry.EventsStore & string}`>(id: T) => Promise<Bud>;
    /**
     * Store callback to an action handler
     *
     * @public
     */
    action: <T extends keyof Registry.EventsStore & string>(id: T, ...input: Array<Registry.EventsCallback>) => Bud;
}
